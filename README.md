...
- Main Campaign:
  ...
  - All the microgames are split into 3 "levels" (8 each).
  - Each microgame is simple in nature, featuring a control scheme limited to the cardinal direction (movement) and an action button.
